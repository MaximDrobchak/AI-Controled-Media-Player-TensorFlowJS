...
// https://codepen.io/blaqbern/pen/VjvMpd
  ...
  render () {
    ...
    return (
      <div className='centeredContent'>
        ...
        <button onClick={this.handleReceived}>Mark Received</button> */}
        {
          fetching ? /*(<div className="modal">
               */ <Spinner segments='43' /> :
          /*</div>)*/
          <button onClick={this.handleFetch}>Fetch</button>}
      </div>
...
class Spinner extends Component {
  ...
  render () {
    ...
    return (
      <svg viewBox='0 0 200 200' preserveAspectRatio='xMidYMid'>
        {
          segments ? segments :
          <path
